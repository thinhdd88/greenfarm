...
/**
 * Adminhtml_Category_Edit_Tab_Content block
 *
 * @category   Pixlogix
 * @package    Pixlogix_Flexibleblog
...
class Pixlogix_Flexibleblog_Block_Adminhtml_Category_Edit_Tab_Content extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * To prepare Category Content Tab on Category Edit page
     *
     * @return Pixlogix_Flexibleblog_Block_Adminhtml_Category_Edit_Tab_Content
     */
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('category_content_fieldset', array(
