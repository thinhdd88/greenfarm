...
/**
 * Adminhtml_Post_Edit_Tab_Meta block
 *
 * @category   Pixlogix
 * @package    Pixlogix_Flexibleblog
...
class Pixlogix_Flexibleblog_Block_Adminhtml_Post_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * To prepare Post Meta Tab on Post Edit page
     *
     * @return Pixlogix_Flexibleblog_Block_Adminhtml_Post_Edit_Tab_Meta
     */
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('post_meta_keyword', 'editor', array(
        ...
        $fieldset->addField('post_meta_description', 'editor', array(
